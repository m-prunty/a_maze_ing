...
class Event_loop:
    ...
    def launch() -> None:
        Mlx_context._mlx.mlx_loop_hook(Mlx_context.get(),
                                       Event_loop.render_event, None)
        Mlx_context._mlx.mlx_key_hook(Window.get(),
                                      Event_loop.input_event, None)
    ...
    @classmethod
    def do_event(cls, event: callable, params: tuple = None) -> None:
        cls._events.append((event, params))

    @classmethod
    def do_repeat(cls, event: callable, params: tuple = None, delay=0.3) -> None:
