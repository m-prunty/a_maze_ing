...
#    Updated: 2026/02/28 11:52:23 by maprunty        ###   ########.fr        #
#                                                                             #
# *************************************************************************** #
...
class Config:
    ...
    def get_pic(self, select: int):
        if select == 1:
            ...
            self.pic = [
                0b1111010001011101110111,
                0b1101011111010100010100,
                0b1111010101011100100111,
                0b1101010101010101000100,
                0b1101010101010101110111,
            ]
        elif select == 3:
            self.pic = [
    0b1000000011100000011111111,
    0b1000001110000001110000111,
    0b1000111011100000000011100,
    0b1011100111000000011100000,
    0b1111111111100011100000000,
    0b1000011100001110000000000,
    0b1000111000111111110110000,
    ]
